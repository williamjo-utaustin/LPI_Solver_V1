...
for n in range(0,4):
    ...
    if(to_plot == 'mass'):
        #plt.ylim(1E-14,1E2)
        plt.ylim(1E-12,1E2)
        plt.savefig(file_folder+"/"+file_folder+"_post_processing/mass.png", bbox_inches='tight',dpi=100)
    elif(to_plot == 'energy'):
        #plt.ylim(1E-8,1E4)
        plt.ylim(1E-6,1E4)
        plt.savefig(file_folder+"/"+file_folder+"_post_processing/energy.png", bbox_inches='tight',dpi=100)
    elif(to_plot == 'count'):
        #plt.ylim(1E0,1E14)
        plt.ylim(1E2,1E16)
        plt.savefig(file_folder+"/"+file_folder+"_post_processing/count.png", bbox_inches='tight',dpi=100)
    elif(to_plot == 'sample'):
        #plt.ylim(1E-3,1E11)
        plt.ylim(1E0,1E14)
        plt.savefig(file_folder+"/"+file_folder+"_post_processing/sample_count.png", bbox_inches='tight',dpi=100)
    else:
        exit("Unknown Variable Plotted")
