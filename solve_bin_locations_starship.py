...
sol_ej.ejecta_ring_bounds = np.genfromtxt("output_starship_nominal/output_starship_nominal_raw_data/starship_nominal_ejecta_ring_bounds.csv", delimiter = ' ')
...
if(sol_ej.plot_only is False):
    ...
    # -----------------------------------------------
    np.savetxt("output_starship_nominal/output_starship_nominal_post_processing/range_bounds.csv", sol_ej.range_bounds_mid, delimiter=",")
    # -----------------------------------------------
    # -----------------------------------------------
    ...
    #for t in range(2260,2273):
        ...
        # -------------------------------------------------------
        ejecta_properties = np.genfromtxt("output_starship_nominal/output_starship_nominal_raw_data/starship_nominal_ejecta_properties_"+str(t)+".csv", delimiter = " ")
        ejecta_velocities = np.genfromtxt("output_starship_nominal/output_starship_nominal_raw_data/starship_nominal_ejecta_velocities_"+str(t)+".csv", delimiter = " ")
        # -------------------------------------------------------
...
#
#
    np.savetxt("output_starship_nominal/output_starship_nominal_post_processing/starship_nominal_high_mass_flux_upon_impact.csv", sol_ej.mass_flux_upon_impact, delimiter=",")
    np.savetxt("output_starship_nominal/output_starship_nominal_post_processing/starship_nominal_high_momentum_flux_upon_impact.csv", sol_ej.momentum_flux_upon_impact, delimiter=",")
    np.savetxt("output_starship_nominal/output_starship_nominal_post_processing/starship_nominal_high_energy_flux_upon_impact.csv", sol_ej.energy_flux_upon_impact, delimiter=",")
    np.savetxt("output_starship_nominal/output_starship_nominal_post_processing/starship_nominal_high_count_flux_upon_impact.csv", sol_ej.count_flux_upon_impact, delimiter=",")
#
