...
#file_folder = "apollo_vel_mid_alt_mid"
#file_folder = "apollo_vel_slow_alt_mid"

#file_folder = "starship_raptor_vel_high_100"
#file_folder = "starship_thruster_vel_high_100"
...
print(file_folder+"/"+file_folder+"_ejecta_ring_bounds.csv")
sol_ej.ejecta_ring_bounds = np.genfromtxt(file_folder+"/"+file_folder+"_ejecta_ring_bounds.csv", delimiter = ' ')
...
if(sol_ej.plot_only is False):
    ...
    # -----------------------------------------------
    np.savetxt(file_folder+"/"+file_folder+"_post_processing/range_bounds.csv", sol_ej.range_bounds_mid, delimiter=",")
    # -----------------------------------------------
    # -----------------------------------------------
    ...
    #for t in range(2260,2273):
        ...
        ejecta_velocities = np.genfromtxt(file_folder+"/"+file_folder+"_ejecta_velocities_"+str(t)+".csv", delimiter = " ")
        # -------------------------------------------------------
...
#
    np.savetxt(file_folder+"/"+file_folder+"_post_processing/"+file_folder+"_mass_flux_upon_impact.csv", sol_ej.mass_flux_upon_impact, delimiter=",")
    np.savetxt(file_folder+"/"+file_folder+"_post_processing/"+file_folder+"_momentum_flux_upon_impact.csv", sol_ej.momentum_flux_upon_impact, delimiter=",")
    np.savetxt(file_folder+"/"+file_folder+"_post_processing/"+file_folder+"_energy_flux_upon_impact.csv", sol_ej.energy_flux_upon_impact, delimiter=",")
    np.savetxt(file_folder+"/"+file_folder+"_post_processing/"+file_folder+"_count_flux_upon_impact.csv", sol_ej.count_flux_upon_impact, delimiter=",")
#
