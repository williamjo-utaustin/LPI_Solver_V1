...
def loop():
    ...
    h_nozzle =  nozzle.h_nozzle_init #m
    min_altitude = nozzle.min_altitude_lander # height of lander
    ...
    # Print out the input variables to make sure we're on the right simulation
    print_simulation_setup()

    for t in range(0,timestep.n_sub_timesteps):
        
        # ----------------------------------------------------------------------------------------------
        # Step 0: Set the initial descent velocity
        # ----------------------------------------------------------------------------------------------
        if(t == 0):
            init_descent_velocity()
        # ----------------------------------------------------------------------------------------------        
        ...
        # ----------------------------------------------------------------------------------------------
        h_nozzle = update_nozzle_height(h_nozzle, t)
        # ----------------------------------------------------------------------------------------------        
