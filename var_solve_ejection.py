...
ejecta_ring_bounds =  np.genfromtxt("output_apollo/output_apollo_raw_data/apollo_ejecta_ring_bounds.csv", delimiter = " ")

n_sim_particles_per_bin = 50
#n_sorted_bins = 50
n_sorted_bins = 1000
...
count_energy_threshold_impact_1 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_2 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_3 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_4 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_5 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_6 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
count_energy_threshold_impact_7 = np.zeros([np.size(soil.d_particle), n_sorted_bins])
