...
def compute_soil_density_depth(z):
    ...
    #soil.rho_bulk = 1920 * (z + 0.3258) / (z + 0.508) # new correlation for A16 ver 1
    soil.rho_bulk = soil.rho_inf * (z + 0.1448) / (z + 0.2317) # new correlation for A16 ver 2
...
def compute_mass_erosion_rate(z):
    ...
    m_dot = m_dot * compute_ratio(z) * scale.scaling_factor[scale.scaling_index]
